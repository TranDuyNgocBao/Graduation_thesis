...
from data import DIV2K, Set5_val, RealSR
import utils
...
parser.add_argument("--root", type=str, default="/content/drive/MyDrive/UIP_Project/ESRT/dataset",
...
testset = Set5_val.DatasetFromFolderVal("/content/drive/MyDrive/UIP_Project/datasets_sync/hr_val_2",
                                       "/content/drive/MyDrive/UIP_Project/datasets_sync/lr_val_2",
                                       args.scale)
...
def valid(scale):
    ...
    wandb.log({"PSNR": avg_psnr, "SSIM": avg_ssim})
