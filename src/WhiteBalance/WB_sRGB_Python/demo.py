...
# input and options
in_img = '/content/drive/MyDrive/UIP_Project/datasets_sync/USR_248/TEST/hr/im_xb_1889_.jpg'  # input image filename
out_dir = '/content/drive/MyDrive/UIP_Project/WB_sRGB/WB_sRGB_Python/results'  # output directory
...
cv2.imwrite(out_dir + '/' + 'result.png', outImg * 255)  # save it
